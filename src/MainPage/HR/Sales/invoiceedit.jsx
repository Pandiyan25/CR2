                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-6 col-md-3">
                          <div className="form-group">
                            ...
                            <div>
                              <input className="form-control datetimepicker" type="date" defaultValue="2019/05/20" />
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6 col-md-3">
                          <div className="form-group">
                            ...
                            <div>
                              <input className="form-control datetimepicker" type="date" defaultValue="2019/05/27" />
                            </div>
                          </div>
                        </div>
                      </div>
