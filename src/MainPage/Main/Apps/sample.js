...
<div className="chats">
                                     <div className="chat-line">
                                      <span className="chat-date">{mesg?.createdAt}</span>
                                    </div>
                                    {
                                      mesg?.sender?._id == loginId ?
                                        <div className="chat chat-right">
                                          <div className="chat-body">
                                            <div className="chat-bubble">
                                              <div className="chat-content">
                                                <p>{mesg?.body}</p>
                                                <span className="chat-time">{mesg?.time}</span>
                                              </div>
                                              <div className="chat-action-btns">
                                                <ul>
                                      {/* <li><a href="#" className="share-msg" title="Share"><i className="fa fa-share-alt" /></a></li>
                                      <li><a href="#" className="edit-msg"><i className="fa fa-pencil" /></a></li> */}
                                      <li><div className="del-msg" onClick={()=>deleteMesg()}> <i className="fa fa-trash-o" /></div></li>
                                    </ul>
                                              </div>
                                            </div>
                                          </div>
