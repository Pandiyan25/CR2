            ...
            <div className="content container-fluid">
              ...
              <section className="comp-section comp-buttons" id="comp_buttons">
                ...
                <div>
                  ...
                  <button type="button" className="btn  mr-1">Secondary</button>
                  ...
                  <p>
                    ...
                    <button type="button" className="btn  btn-lg mr-1">Secondary</button>
                  ...
                  <p>
                    ...
                    <button type="button" className="btn  btn-sm mr-1">Secondary</button>
              ...
              <section className="comp-section comp-dropdowns" id="comp_dropdowns">
                ...
                <div>
                  ...
                  <div className="btn-group">
                    <button type="button" className="btn  dropdown-toggle mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                    <div className="dropdown-menu">
                      <a className="dropdown-item" href="#">Action</a>
                      <a className="dropdown-item" href="#">Another action</a>
                      <div className="dropdown-divider" />
                  ...
                  <div className="btn-group">
                    ...
                    <button type="button" className="btn  dropdown-toggle dropdown-toggle-split mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <span className="sr-only">Toggle Dropdown</span>
                    </button>
                    <div className="dropdown-menu">
                      <a className="dropdown-item" href="#">Action</a>
