...
const EditPublicRound = ({ handleClose, publicId, getFundingRound, indexCountforSlect }) => {
    ...
    const submitDataFunc = (MAINsTATUS) => {
        try {
            var mileStoneArray = []
                    ...
                    body: JSON.stringify({
                        ...
                        variables: {
                            ...
                            "input": {
                                ...
                                "founder_status": MAINsTATUS,
                                "investor_status":'Received',
                                // MAINsTATUS
                                // "investor":"62b0614e758bcafba2f14f50"
                            }
                        }
            ...
            <div className="col-md-12">
                <div className="row" style={{ padding: '10px' }}>
                    ...
                    <div className="col-md-12" style={{ marginBottom: '1rem', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <div style={{ width: '300px' }}>
                            {/* onChange={(e) => setExpFreq(e.target.value)} onWheel={(e) => e.target.blur()} */}
                            <input type="text" className="form-control" style={{ width: '300px' }} readOnly='true' value={Valuation} onChange={(e) => setValuation(e.target.value)} />
                    ...
                    <div className="col-md-12" style={{ marginBottom: '1rem', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <div style={{ width: '300px' }}>
                            ...
                            <select className="form-control btn-block-height square-edges" value={InitialRelease} onChange={(e) => setInitialFunc(e)} >
                                {Count.map((_, i) => (
                   ...
                   {/* <div className="col-md-12" style={{marginBottom:'1rem',display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <div className="col-md-12" style={{marginBottom:'1rem',display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <div style={{ width: '300px' }}>
                            ...
                            <input type="date" min={todayMite} className="form-control" style={{ width: '300px' }} value={EndtargetDate} onChange={(e) => setEndtargetDate(e.target.value)} />
                    ...
                    {/* <div className="form-group" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'space-between' }} > */}
                        ...
                        <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div className="" style={{ textAlign: 'center', marginRight: '15px' }}>
                                <button className="btn btn-primary submit-btn" onClick={() => submitDataFunc("Draft")} >SAVE DRAFT</button>
                            </div>

                            <div className="" style={{ textAlign: 'center' }}>
                                <button className="btn btn-primary submit-btn" onClick={() => submitDataFunc("Accepted")} >LAUNCH PUBLIC ROUND</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default EditPublicRound;
