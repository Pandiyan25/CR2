                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control"   defaultValue={emailId} onChange={(e) => setEmailId(e.target.value)} />
                                        </div>
                                    </div>
...
{/*                                   
                ...
                <div className="submit-section">
                  <button className="btn btn-primary submit-btn" onClick={()=>saveNewPojectData()}>SAVE</button>
                </div>
