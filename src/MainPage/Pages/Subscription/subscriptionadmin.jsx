                        ...
                        <div className="col-md-4">
                          <div className="card pricing-box">
                            <div className="card-body d-flex flex-column">
                              ...
                              <a href="#" className="btn btn-lg  mt-auto" data-toggle="modal" data-target="#edit_plan">Edit</a>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-4">
                                ...
                                <table className="table table-hover table-center mb-0">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>Free</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">30 Users</Link></td>
                                    </tr>
                                    <tr>
                                      <td>Professional</td>
                                      <td>Monthly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$21</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">97 Users</Link></td>
                                    </tr>
                                    <tr>
                                      <td>Enterprise</td>
                                      <td>Monthly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$38</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">125 Users</Link></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                                ...
                                <table className="table table-hover table-center mb-0">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>Free</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">62 Users</Link></td>
                                    </tr>
                                    <tr>
                                      <td>Professional</td>
                                      <td>Yearly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$199</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">157 Users</Link></td>
                                    </tr>
                                    <tr>
                                      <td>Enterprise</td>
                                      <td>Yearly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$399</td>
                                      <td><Link className="btn btn-info btn-sm" to="/app/subscription/subscribedcompanies">241 Users</Link></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
