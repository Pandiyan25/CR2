...
const AcceptedInvestorPrivatePage = ({ getFundingRound,indexCountforSlect, publicId, handleClose }) => {
    ...
    const [FundRaiseStatus, setFundRaiseStatus] = useState([])
    ...
    const [chooseMileStonedata2, setChooseMileStonedata] = useState([
        {
          ...
          'x-range-name': process.env.RANGE_NAME
                ...
                .then(data => {
                    ...
                    if (data?.data?.getFundraise != null && data?.data?.getFundraise != undefined) {
                        ...
                        setFundRaiseStatus([data?.data?.getFundraise])
                        ...
                        <div className="row align-items-center" style={{ width: '100%', margin: '0px' }}>
                            <div className="col" style={{ padding: '0px' }}>
                                ...
                                <div className="search mb-2">
                                    ...
                                    <h3 className="card-title mb-0" style={{ padding: '10px' }}>Private Round</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="row" style={{ padding: '10px' }}>
                         ...
                         <label style={{ width: '310px', marginBottom: '0px' }}>Project<span className="text-danger">*</span></label>
                                                ...
                                                <tr key={index}>
                                                    {/* <td style={{ width: '20%', padding: '10px' }}>
                                                        <div>
                                                            ...
                                                            <select className="form-control btn-block-height square-edges" value={i?.choose} readOnly='true'>
                                                    ...
                                                    <td style={{ width: '25%', padding: '10px' }}>
                                                        {
                                                            i.choose == 'Choose_MileStone' ?
                                                                ...
                                                                <input type='text' className="form-control" value={"MileStone 1"} readOnly='true' />
                                                    ...
                                                    <td style={{ width: '12%', padding: '10px' }}>
                                                        ...
                                                        <input type='text' className="form-control" value={`${i?.percentage}%`} readOnly='true' />
                        ...
                        submit-section */}
                                ...
                                {
                                    FundRaiseStatus[0]?.investor_status == 'Sent' && FundRaiseStatus[0]?.deposited == false && FundRaiseStatus[0]?.founder_status == 'Accepted' ?
                                    ...
                                    <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <div className="" style={{ textAlign: 'center', marginRight: '15px' }}>
                                            <button className="btn btn-primary submit-btn" onClick={() => depositTokensIntoRound()}>{"Deposit"}</button>
                                        </div>
                                ...
                                //     FundRaiseStatus.length > 0 && FundRaiseStatus[0].investor_status == 'Sent' ?
                                ...
                                // <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                // <div className="" style={{ textAlign: 'center', marginRight: '15px' }}>
                                //     <button className="btn btn-primary submit-btn" >{"Deposit"}</button>
                                // </div>
...
export default AcceptedInvestorPrivatePage;
