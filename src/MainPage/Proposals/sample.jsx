                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ textAlign: 'center', padding: '10px 0px !important', borderBottom: '0px', borderTop: '0px' }}>Proposal No</th>
                                            ...
                                            <th style={{ textAlign: 'center', padding: '10px 0px !important', borderBottom: '0px', borderTop: '0px' }}>Validation Status</th>
                                            <th style={{ textAlign: 'center', padding: '10px 0px !important', borderBottom: '0px', borderTop: '0px' }}>Fund Released Date</th>
                                            ...
                                            <th style={{ textAlign: 'center', padding: '10px 0px !important', borderBottom: '0px', borderTop: '0px' }}>Options</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {tableData.map((i) => (
                                            <tr>
                                                ...
                                                <td style={{ textAlign: 'center', padding: '10px 0px !important' }}>{i.proposalNo}</td>
                                                ...
                                                <td style={{ textAlign: 'center', padding: '10px 0px !important' }}><div className="">
                                                    <button className="btn buttonInProposal1 submit-btn2" onClick={() => showProposalsDataFun(i)}>View</button>
                                                </div></td>
...
const ProposalRoute = () => {
    ...
    return (
        ...
        <div className="card card-table flex-fill" style={{ border: '0px' }}>
